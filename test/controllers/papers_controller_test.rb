...
class PapersControllerTest < ActionController::TestCase
  ...
  test "should create paper" do
    assert_difference('Paper.count') do
      post :create, paper: { abstract: @paper.abstract, paper_title: @paper.paper_title, type_of_conference: @paper.type_of_conference }
    end
  ...
  test "should update paper" do
    patch :update, id: @paper, paper: { abstract: @paper.abstract, paper_title: @paper.paper_title, type_of_conference: @paper.type_of_conference }
    assert_redirected_to paper_path(assigns(:paper))
  end
